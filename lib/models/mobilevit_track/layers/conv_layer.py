...
class ConvLayer(BaseLayer):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if use_norm:
            norm_type = getattr(opts, "conv_layer_normalization_name", "batch_norm")
        ...
        ################## Create a convolution + normalization + non-linearity block ##################################
        ...
        self.act_name = None
        act_type = (
            getattr(opts, "conv_layer_activation_name", "prelu")
            if act_name is None
            else act_name
        )
        """
        act_type = opts["conv_layer_activation_name"]
