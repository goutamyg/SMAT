...
class MobileViTv2Track(BaseTracker):
    ...
    def __init__(self, params, dataset_name):
        ...
        self.engine_file_path = Path(weights_path.with_suffix('.fp32.engine'))
    ...
    def build_engine(self, onnx_file_path, engine_file_path):
        ...
        @param onnx_file_path: The path where the onnx model is saved.
        @param engine_file_path: The path where the optimized tensorRT engine will be saved/stored
        returns the optimized tensorrt engine
        """
